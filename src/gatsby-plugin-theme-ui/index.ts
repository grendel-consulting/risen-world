...
const breakpoints: ThemeSkald["breakpoints"] = Object.values(breakpointsDict);
...
const colors: ThemeSkald["colors"] = {
  ...palette,
  text: palette.neutral[4],
  background: palette.neutral[0],
  primary: palette.darkGrayBlue,
  secondary: palette.darkBlue,
  accent: palette.softBlue,
  highlight: palette.softOrange,
...
const fontSizes: ThemeSkald["fontSizes"] = [
  16,
  18,
  20,
  24,
...
const fontWeights: ThemeSkald["fontWeights"] = {
  body: 300,
  heading: 700,
  bold: 500,
};

const letterSpacings: ThemeSkald["letterSpacings"] = {};

const lineHeights: ThemeSkald["lineHeights"] = {
  body: 1.667,
  heading: 1.125,
};
...
const space: ThemeSkald["space"] = Object.values(spaceDict);

const sizes: ThemeSkald["sizes"] = {
  ...spaceDict,
  ...breakpointsDict,
  full: `100%`,
  screenHeight: `100vh`,
...
const zIndices: ThemeSkald["zIndices"] = {};

// ==================================================
// Theme scale > Borders
// ==================================================
const borders: ThemeSkald["borders"] = {};

const borderWidths: ThemeSkald["borderWidths"] = {
  "0": `0`,
  none: `0`,
  sm: `2px`,
  md: `4px`,
...
const borderStyles: ThemeSkald["borderStyles"] = {};

const radii: ThemeSkald["radii"] = {
  "0": `0`,
  none: `0`,
  default: `4px`,
  full: `100%`,
...
// ==================================================
const opacities: ThemeSkald["opacities"] = {
  "0": `0`,
  none: `0`,
  low: `0.2`,
  half: `0.5`,
...
const shadows: ThemeSkald["shadows"] = {};

// ==================================================
// Transitions
// ==================================================
const transitions: ThemeSkald["transitions"] = {
...
// Theme styles
// ==================================================
const styles: ThemeSkald["styles"] = {
  root: {
...
// ==================================================
const layout: ThemeSkald["layout"] = {
  container: {
    // borderWidth: "md",
...
const buttons: ThemeSkald["buttons"] = {
  primary: {
    ...baseButton,
...
const forms: ThemeSkald["forms"] = {};

const badges: ThemeSkald["badges"] = {
  primary: {
    backgroundColor: `primary`,
  },
  secondary: {
...
const alerts: ThemeSkald["alerts"] = {
  primary: {
    backgroundColor: `primary`,
    color: `white`,
  },
...
const messages: ThemeSkald["messages"] = {};
...
// ==================================================
export const themeSkald: ThemeSkald = {
